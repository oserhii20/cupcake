    ...
    <div className="slider">
      <div className="container mx-auto ">
        <div className="flex flex-wrap justify-center items-center">
          ...
          <div className="md:w-1/2 pr-4 pl-4 bg-images">
    ...
    <section className="brand_logo">
      ...
      <div className="container mx-auto ">
        <div className="flex flex-wrap ">
            <div className="w-1/2 sm:w-1/3 md:w-1/6 pr-4 pl-4"><a href="https://www.lollapalooza.com/" target={"_blank"}><img src={require('../../assets/images/p-1.png')} /></a></div>
            <div className="w-1/2 sm:w-1/3 md:w-1/6 pr-4 pl-4"><a href="https://usa.tommy.com/en" target={"_blank"}><img src={require('../../assets/images/p-2.png')} /></a></div>
            <div className="w-1/2 sm:w-1/3 md:w-1/6 pr-4 pl-4"><a href="https://solana.com/" target={"_blank"}><img src={require('../../assets/images/p-3.png')} /></a></div>
            <div className="w-1/2 sm:w-1/3 md:w-1/6 pr-4 pl-4"><a href="https://degentrashpandas.com/" target={"_blank"}><img src={require('../../assets/images/p-4.png')} /></a></div>
            <div className="w-1/2 sm:w-1/3 md:w-1/6 pr-4 pl-4"><a href="https://injective.com/" target={"_blank"}><img src={require('../../assets/images/p-5.png')} /></a></div>
            <div className="w-1/2 sm:w-1/3 md:w-1/6 pr-4 pl-4"><a href="#" target={"_blank"}><img src={require('../../assets/images/p-6.png')} /></a></div>
        </div>
      </div>
